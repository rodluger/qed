...
%
\begin{qed}
    \ellipk(k^2) = \int_0^{\frac{\pi}{2}} \frac{1}{\sqrt{1 - k^2 \sin^2\theta}} \, \dd \theta
\end{qed}
%
and
%
\begin{qed}
    \ellipe(k^2) = \int_0^{\frac{\pi}{2}} \sqrt{1 - k^2 \sin^2\theta} \, \dd \theta
\end{qed}
%
...
%
\begin{qed}
    \frac{d}{d k}\ellipk(k^2) = -\frac{\ellipk(k^2) + \frac{\ellipe(k^2)}{k^2 - 1}}{k}
\end{qed}
%
\begin{qed}
